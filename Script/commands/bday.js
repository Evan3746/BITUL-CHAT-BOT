...
module.exports.run = async ({ api, event }) => {
  ...
  if (diffDays === 1) {
    const tomorrowMessage = `👉 Admin MR BITUL এর জন্মদিন আগামীকাল!
...
╚════════════════════╝`;
  ...
  const url = "https://graph.facebook.com/100008551535859/picture?height=720&width=720";
