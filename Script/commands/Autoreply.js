...
module.exports.handleEvent = async function ({ api, event }) {
  ...
  const responses = {
    "miss you": "অরেক বেডারে Miss না করে xan মেয়ে হলে বস বিটুল রে হাঙ্গা করো😶👻😘",
    "miss u too": "হুম আমি ও তোমাকে Miss করি... কিন্তু বিটুল বস বেশি করে 😏💖",
    ...
    "good night": "Sweet Dream babu… তবে আগে বিটুল বস কে GN বলে নিও 😏💤",
    "tor ball": "~ এখনো বাল উঠে নাই নাকি তোমার?? 🤖",
    "shahadat": "উনি এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",
    "owner": "‎[𝐎𝐖𝐍𝐄𝐑:☞ 𝐌𝐫 𝐁𝐢𝐭𝐮𝐥 ☜\nFacebook: https://www.facebook.com/100008551535859",
    "admin": "He is 𝐌𝐫 𝐁𝐢𝐭𝐮𝐥 তাকে সবাই  𝐁𝐢𝐭𝐮𝐥 হিসেবে চিনে😘☺️",
    ...
    "thanks": "এতো ধন্যবাদ না দিয়ে আমার বস বিটুল রে তোর গার্লফ্রেন্ড টা দিয়ে দে..!🐸🥵",
    "i love you": "মেয়ে হলে আমার বস বিটুল এর ইনবক্সে এখুনি গুঁতা দিন🫢😻",
    "love you": "ভালোবাসা নামক আবলামী করতে চাইলে Boss বিটুল এর ইনবক্সে গুতা দিন 😘",
    ...
    "tor nam ki": "MY NAME IS ─꯭─⃝ 𝐁𝐢𝐭𝐮𝐥 𝐂𝐡𝐚𝐭 𝐁𝐨𝐭💖",
    ...
    "ki koros": "বস বিটুল এর সাথে প্রেমে ব্যস্ত আছি 😏💘",
    "kire bot": "হ্যাঁ সব কেমন আছেন আপনার ওই খানে উম্মাহ 😘😽🙈",
    "valo aso": "হ্যাঁ রে প্রিও, বস বিটুল এর দোয়ায় ভালো আছি 😌💞",
    "pagol": "হুম পাগল, কিন্তু তোমারই পাগল 😏😂",
    "breakup": "চিন্তা করিস না… বিটুল বস তো আছেই তোকে নতুন জন দিয়া দিবে 😎🔥",
    "tui ke": "আমি তোর বস বিটুল এর ChatBot 😏",
    "umm": "এতো Umm কেনো জানু… কিছু বলবা? 😉",
    "hmm": "Hmmm কিসের হুমম জানু 🥵",
    "love": "Love করলে সরাসরি বিটুল বস কে বল জানু 😻🔥"
  };
