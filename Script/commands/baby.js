...
const greetings = [
        ...
        "শুনবো না😼 তুমি আমার বস বিটুল কে প্রেম করাই দাও নাই🥺পচা তুমি🥺",
        "আমি আবাল দের সাথে কথা বলি না,ok😒",
        "এতো ডেকো না,প্রেম এ পরে যাবো তো🙈",
        "Bolo Babu, তুমি কি আমার বস বিটুল কে ভালোবাসো? 🙈💋",
        ...
        "আমাকে না ডেকে মেয়ে হলে বস বিটুল এরর ইনবক্সে চলে যা 🌚😂 ",
        "আমাকে বট না বলে , বস বিটুল কে জানু বল জানু 😘",
        ...
        "আমাকে ডেকো না,আমি বস বিটুল এর সাথে ব্যাস্ত আছি",
        "কি হলো , মিস্টেক করচ্ছিস নাকি🤣",
        "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏",
        "জান মেয়ে হলে বস বিটুল এর ইনবক্সে চলে যাও 😍🫣💕 𝐅",
        ...
        "আমাকে এতো না ডেকে বস বিটুল কে একটা গফ দে 🙄",
        ...
        "জান তোমার বান্ধবী রে আমার বস বিটুল এর হাতে তুলে দিবা-🙊🙆‍♂",
        "আজকে আমার মন ভালো নেই তাই আমারে ডাকবেন না-😪🤧",
        "ঝাং 🫵থুমালে য়ামি রাইতে পালুপাসি উম্মম্মাহ-🌺🤤💦",
        "চুনা ও চুনা আমার বস বিটুল এর হবু বউ রে কেও দেকছো খুজে পাচ্ছি না😪🤧😭",
        "স্বপ্ন তোমারে নিয়ে দেখতে চাই তুমি যদি আমার হয়ে থেকে যাও-💝🌺🌻",
        "জান হাঙ্গা করবা-🙊😝🌻",
        "জান মেয়ে হলে চিপায় আসো বস বিটুল এর থেকে অনেক ভালোবাসা শিখছি তোমার জন্য-🙊🙈😽",
        "ইসস এতো ডাকো কেনো লজ্জা লাগে তো-🙈🖤🌼",
        "আমার বস সাহুর পক্ষ থেকে তোমারে এতো এতো ভালোবাসা-🥰😽🫶 আমার বস সাহু ইসলামে'র জন্য দোয়া করবেন-💝💚🌺🌻",
        "- ভালোবাসা নামক আব্লামি করতে মন চাইলে আমার বস বিটুল এর ইনবক্স চলে যাও-🙊🥱👅 🌻",
        "আমার জান তুমি শুধু আমার আমি তোমারে ৩৬৫ দিন ভালোবাসি-💝🌺😽",
        "কিরে প্রেম করবি তাহলে বস বিটুল এর ইনবক্সে গুতা দে 😘🤌 ",
        "জান আমার বস বিটুল  কে বিয়ে করবা-🙊😘🥳",
        "-আন্টি-🙆-আপনার মেয়ে-👰‍♀️-রাতে আমারে ভিদু কল দিতে বলে🫣-🥵🤤💦",
        "oii-🥺🥹-এক🥄 চামচ ভালোবাসা দিবা-🤏🏻🙂",
        "-আপনার সুন্দরী বান্ধুবীকে ফিতরা হিসেবে আমার বস বিটুল কে দান করেন-🥱🐰🍒",
        "-ও মিম ও মিম-😇-তুমি কেন চুরি করলা সাদিয়ার ফর্সা হওয়ার ক্রীম-🌚🤧",
        "-অনুমতি দিলাম-𝙋𝙧𝙤𝙥𝙤𝙨𝙚 কর বস বিটুল কে-🐸😾🔪",
        ...
        "প্রেম করতে চাইলে বস বিটুল এর ইনবক্সে চলে যা 😏🐸 ",
        "-আজ একটা বিন নেই বলে ফেসবুকের নাগিন-🤧-গুলোরে আমার বস সাহু ধরতে পারছে না-🐸🥲",
        "-চুমু থাকতে তোরা বিড়ি খাস কেন বুঝা আমারে-😑😒🐸⚒️",
        "—যে ছেড়ে গেছে-😔-তাকে ভুলে যাও-🙂-আমার বস বিটুল এর সাথে প্রেম করে তাকে দেখিয়ে দাও-🙈🐸🤗",
        "—হাজারো লুচ্চা লুচ্চির ভিরে-🙊🥵আমার বস বিটুল এক নিস্পাপ ভালো মানুষ-🥱🤗🙆‍♂️",
        ...
        "ভালোবাসার নামক আবলামি করতে চাইলে বস বিটুল কে  ইনবক্সে গুতা দিন🤣😼",
        ...
        "-ওই বেডি তোমার বাসায় না আমার বস সাহু মেয়ে দেখতে গেছিলো-🙃-নাস্তা আনারস আর দুধ দিছো-🙄🤦‍♂️-বইন কইলেই তো হয় বয়ফ্রেন্ড আছে-🥺🤦‍♂-আমার বস বিটুল কে জানে মারার কি দরকার-🙄🤧",
        ...
        "-দেশের সব কিছুই চুরি হচ্ছে-🙄-শুধু আমার বস বিটুল এর মনটা ছাড়া-🥴😑😏",
 ...
 if (
 raw === "hi" || raw === "baby" || raw === "bot" || raw === "bby" || raw === "oii" || raw === "koi" ||
 ...
 if (
 raw.startsWith("oii ") || raw.startsWith("koi ") || raw.startsWith("hi ") || raw.startsWith("baby ") || raw.startsWith("bot ") || raw.startsWith("bby ") ||
